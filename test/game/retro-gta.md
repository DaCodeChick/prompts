...
1. **Language:** C99 (preferred for non-Windows, otherwise C89 for Visual C on Win32), C++98 or C++03. Absolutely no C++11 or later, no `auto`, no lambdas, no `<unordered_map>`.
